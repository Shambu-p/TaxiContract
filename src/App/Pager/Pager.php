...
class Pager {
    ...
    public static function pagerView($name){
        ...
        if($_SESSION["pager"][$name]["current_page"] > 1){
            ...
            $reqs["page_number"] = 1;
            print '<a href="'.Route::route_address($_SESSION["pager"][$name]["route_name"], $reqs, "get").'" type="button" class="'.$_SESSION["pager"][$name]["link_class"].'">First</a>';

            $reqs["page_number"] = $_SESSION["pager"][$name]["current_page"] - 1;
            print '<a href="'.Route::route_address($_SESSION["pager"][$name]["route_name"], $reqs, "get").'" type="button" class="'.$_SESSION["pager"][$name]["link_class"].'"> < </a>';
        ...
        for($i = 1; $i <= $_SESSION["pager"][$name]["max_size"]; $i++){
            ...
            if($_SESSION["pager"][$name]["current_page"] == $i){
                ...
                $reqs["page_number"] = $i;
                print '<a href="'.Route::route_address($_SESSION["pager"][$name]["route_name"], $reqs, "get").'" class="'.$_SESSION["pager"][$name]["link_class"].'">'.$i.'</a>';
        ...
        if($_SESSION["pager"][$name]["current_page"] < $_SESSION["pager"][$name]["max_size"]){
            ...
            $reqs["page_number"] = $_SESSION["pager"][$name]["current_page"] + 1;
            print '<a href="'.Route::route_address($_SESSION["pager"][$name]["route_name"], $reqs, "get").'" class="'.$_SESSION["pager"][$name]["link_class"].'"> > </a>';

            $reqs["page_number"] = $_SESSION["pager"][$name]["max_size"];
            print '<a href="'.Route::route_address($_SESSION["pager"][$name]["route_name"], $reqs, "get").'" class="'.$_SESSION["pager"][$name]["link_class"].'">Last</a>';
    ...
    public static function check($name){
        return isset($_SESSION["pager"][$name]);
    }
